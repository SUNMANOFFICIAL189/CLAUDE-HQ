...
Verified with `git apply --check` against a pristine tag checkout on 2026-09-03. Reviewed by: T5 blind verify, `/proof-check`, re-run #1, re-run #3 (CLEAN) — see `../reviews/`.
